    ...
    variants: {
      intent: {
        ...
        primary: [
          "bg-[#F59E0B]", // Amber-500
          "text-[#fff]",
          "hover:enabled:bg-[#FBBF24]", // Amber-400
          "disabled:bg-[#FDE68A]", // Amber-200
          "[box-shadow:inset_0px_-2.108433723449707px_0px_0px_#D97706,_0px_1.2048193216323853px_6.325301647186279px_0px_rgba(245,_158,_11,_40%)]",
          "hover:enabled:[box-shadow:inset_0px_-2.53012px_0px_0px_#F59E0B,_0px_1.44578px_7.59036px_0px_rgba(245,_158,_11,_50%)]",
          "disabled:shadow-none",
          "active:bg-[#B45309]", // Amber-700
          "active:[box-shadow:inset_0px_-1.5px_0px_0px_#92400E,_0px_0.5px_2px_0px_rgba(245,_158,_11,_60%)]",
        ],
        secondary: [
          "bg-[#FFFFFF]",
          "text-[#36322F]",
